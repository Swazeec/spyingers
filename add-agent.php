                ...
                <div class="col-12 col-lg-6  px-md-5">
                    <form action="" method="post" class="row p-3  rounded " id="addTargetForm">
                        ...
                        <div class="col-12 mb-3 d-flex flex-column" >
                            ...
                            <select id="specialities" name="specialities[]" class="fs-6 text-white p-1 m-0 form-select border-0 white39" multiple required>
                                <?php 
...
<script src="./src/scripts/add-agent.js"></script>
