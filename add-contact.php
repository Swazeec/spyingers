...
if(isset($_SESSION['connect'])){ 
    ...
    <section class="row d-block">
        <div class="col-12  pt-4 pt-md-5 pb-md-5">
                <h2 class=" text-white text-center">AJOUTER UN CONTACT</h2>
        </div>
        <div class="col-12">
            <article class="row p-3 py-5 white39 rounded mx-0 mx-md-3">
                <div class="col-6 d-none d-lg-block text-center">
                    <img src="./img/spyingers-contact-ill.svg" alt="illustration de cible">
                </div>
...
<script src="./src/scripts/add-contact.js"></script>
